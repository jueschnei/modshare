...
$result = $db->query('SELECT b.user_id,b.ip,b.message,b.expires,u.username FROM bans AS b
...
<form action="/admin/edit_ban/<?php echo intval($dirs[3]); ?>" method="post" enctype="multipart/form-data">
	...
	<table border="0">
		...
		<tr>
			...
			<td><input type="text" name="ip" value="<?php echo clearHTML($cur_ban['ip']); ?>" /></td>
		...
		<tr>
			...
			<td><input type="text" name="message" value="<?php echo clearHTML($cur_ban['message']); ?>" /></td>
