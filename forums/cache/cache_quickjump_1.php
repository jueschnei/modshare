...
?>				<form id="qjump" method="get" action="viewforum.php">
					...
					<select name="id" onchange="window.location=('viewforum.php?id='+this.options[this.selectedIndex].value)">
						...
						<optgroup label="Team Discussion">
							<option value="12"<?php echo ($forum_id == 12) ? ' selected="selected"' : '' ?>>Feature Testing Forum</option>
							<option value="15"<?php echo ($forum_id == 15) ? ' selected="selected"' : '' ?>>Team discussion</option>
							<option value="18"<?php echo ($forum_id == 18) ? ' selected="selected"' : '' ?>>Trash bin &gt;&gt;&gt;</option>
						</optgroup>
					</select>
