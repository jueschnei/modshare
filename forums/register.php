...
if (isset($_POST['form_sent']))
{
	...
	//anti-spam
	if ($_POST['pwd3'] != '') {
		message('Your registration has been detected as spam. Please stop spamming our forums');
	}
	
	if (strstr($email1, '@hotmail.com')) {
		message('Your registration has been detected as spam. Please stop spamming our forums.');
	}
...
?>
			...
			<input type="password" name="pwd3" style="display:none" />
